...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "include" /I "src" /I "$(LIBGLIBUTIL_ROOT)/include" /I "$(GTK_ROOT)/include/glib-2.0" /I "$(GTK_ROOT)/lib/glib-2.0/include" /I "$(OPENSSL_ROOT)/include" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "include" /I "src" /I "$(LIBGLIBUTIL_ROOT)/include" /I "$(GTK_ROOT)/include/glib-2.0" /I "$(GTK_ROOT)/lib/glib-2.0/include" /I "$(OPENSSL_ROOT)/include" /D "WIN32" /D "_DEBUG" /D "DEBUG" /D "_MBCS" /D "_LIB" /FR /FD /GZ /c
# SUBTRACT CPP /YX
