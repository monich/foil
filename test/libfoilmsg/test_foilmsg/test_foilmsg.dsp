...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../../common" /I "../../../libfoilmsg/include" /I "$(LIBFOIL_ROOT)/include" /I "$(LIBGLIBUTIL_ROOT)/include" /I "$(GTK_ROOT)/include/glib-2.0" /I "$(GTK_ROOT)/lib/glib-2.0/include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "../../common" /I "../../../libfoilmsg/include" /I "$(LIBFOIL_ROOT)/include" /I "$(LIBGLIBUTIL_ROOT)/include" /I "$(GTK_ROOT)/include/glib-2.0" /I "$(GTK_ROOT)/lib/glib-2.0/include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "DEBUG" /FR /FD /GZ /c
# SUBTRACT CPP /YX
